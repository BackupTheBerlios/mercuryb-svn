 ...
 *
 * $Id: en.php,v 1.122 2007/06/17 10:07:21 jon Exp $
 **/
...
class en
{
	...
	function cp()
	{
		...
		$this->cp_editing_avatar_disabled = 'You are not allowed to edit your avatar.';
		$this->cp_editing_profile = 'Editing Profile';
		$this->cp_editing_profile_disabled = 'You are not allowed to edit your profile.';
		$this->cp_email = 'Email';
		...
		$this->cp_sub_perm = 'You do not have permission to subscribe to this forum';
	...
	function forum()
	{
		...
		$this->forum_rating = 'Topic Rating';
	...
	function new_posts()
	{
		...
		$this->new_posts_rating = 'Topic Rating';
	...
	function pm()
	{
		...
		$this->pm_buddy_yourself = 'You cannot add yourself to your own buddy list';
	...
	function register()
	{
		...
		$this->register_agree = 'I agree to these Terms & Conditions and I accepted full repsonsibilty for my actions';
		$this->register_condition_failed = 'You must accept the Terms & Conditions in order to register';
		$this->register_conditions_title = 'Terms & Conditions';
	...
	function topic()
	{
		...
		$this->topic_no_rate_selected = 'There is no rating selected';
		...
		$this->topic_rate = 'Rate';
		$this->topic_rating = 'Topic Rating';
		$this->topic_rated = 'Your selected rating has been processed and the overall topic rating has been updated';
		$this->topic_rated_already = 'You have already rated this topic';
		$this->topic_rate_perm = 'You do not have permission to rate topics.';
		$this->topic_rate_own = 'You cannot rate your own topics';
