 ...
 *
 * $Id: pt.php,v 1.48 2007/07/28 10:06:06 jon Exp $
 **/
...
class pt
{
	...
	function cp()
	{
		...
		$this->cp_editing_avatar_disabled = 'You are not allowed to edit your avatar.'; //Translate
		$this->cp_editing_profile = 'Corrigindo seus dados';
		$this->cp_editing_profile_disabled = 'You are not allowed to edit your profile.'; //Translate
		...
		$this->cp_sub_perm = 'You do not have permission to subscribe to this forum'; //Translate
	...
	function forum()
	{
		...
		$this->forum_rating = 'Topic Rating'; //Translate
	...
	function new_posts()
	{
		...
		$this->new_posts_rating = 'Topic Rating'; //Translate
	...
	function pm()
	{
		...
		$this->pm_buddy_yourself = 'You cannot add yourself to your own buddy list'; //Translate
	...
	function register()
	{
		...
		$this->register_agree = 'I agree to these Terms & Conditions and I accepted full repsonsibilty for my actions'; //Translate
		$this->register_condition_failed = 'You must accept the Terms & Conditions in order to register'; //Translate
		$this->register_conditions_title = 'Terms & Conditions'; //Translate
	...
	function search()
	{
		...
		$this->search_sep_thousands = ','; //Translate
	...
	function topic()
	{
		...
		$this->topic_no_rate_selected = 'There is no rating selected'; //Translate
		...
		$this->topic_rate = 'Rate'; //Translate
		$this->topic_rate_own = 'You cannot rate your own topics'; //Translate
		$this->topic_rate_perm = 'You do not have permission to rate topics.'; //Translate
		$this->topic_rated = 'Your selected rating has been processed and the overall topic rating has been updated'; //Translate
		$this->topic_rated_already = 'You have already rated this topic'; //Translate
		$this->topic_rating = 'Topic Rating'; //Translate
