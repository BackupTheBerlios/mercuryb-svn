 ...
 *
 * $Id: forum.php,v 1.74 2007/06/10 10:39:47 jon Exp $
 **/
...
class forum extends mercuryboard
{
	...
	function getTopics($f, $min, $n, $order)
	{
		...
		SELECT
		    ...
		    t.topic_edited, t.topic_icon, t.topic_views, t.topic_description, t.topic_moved, t.topic_rate, t.topic_forum,
		...
		while ($row = $this->db->nqfetch($query))
		{
			...
			if (($row['topic_rate'] != 0) && ($this->perms->auth('topic_rate', $row['topic_forum']))) {
				$topic_rate = '<img src="./skins/' . $this->skin . '/images/' . $row['topic_rate'] . '.gif" alt="' . $this->lang->forum_rating . '" align="right"/>';
			}else{
				$topic_rate = "";
			}
