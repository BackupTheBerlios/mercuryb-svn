 ...
 *
 * $Id: members.php,v 1.36 2007/07/04 19:58:24 jon Exp $
 **/
		...
		case 'profile':
			...
			if (!isset($this->post['submit'])) {
				...
				if (($this->post['user_group'] == USER_BANNED) && ($this->get['id'] == USER_GUEST_UID)) {
					return $this->message('Member Control', 'You cannot ban Guests, this would cause your board to become unusable');
				}
				...
				if ($this->post['user_group'] == USER_BANNED ) {
                    $this->db->query("DELETE FROM {$this->pre}subscriptions WHERE subscription_user=" . $this->get['id']);
                }
